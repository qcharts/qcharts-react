        ...
        e = Object(n.a)(
          ...
          [
            function() {
              ...
              return t('p', [
                this._v('可以通过 '),
                t('code', { pre: !0 }, [this._v('tickStep')]),
                this._v(' 和 '),
                t('code', { pre: !0 }, [this._v('tickLength')]),
                this._v(' 分别控制 tick 的生成数和长度。当 '),
                t('code', { pre: !0 }, [this._v('tickLength')]),
                this._v(' 为负值时，将在外圈绘制刻度。')
              ])
            },
            function() {
              var s = this.$createElement,
              ...
              return t('p', [
                this._v('可以通过 '),
                t('code', { pre: !0 }, [this._v('labelOffset')]),
                this._v(' 设置文字和刻度之间的距离。')
              ])
            }
          ],
          !1,
